...
const DashboardTab: React.FC<DashboardTabProps> = ({
  ...
  const kpis = useMemo(() => {
    ...
    // Calculate period-specific stats from filtered `contrats` using direct commercial field
    ...
    // Determine active commercials in the period from filtered `contrats`
